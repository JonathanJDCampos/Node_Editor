                     ...
                     float splitter_long_axis_size = -1.0f)
{
    ...
    bb.Max = bb.Min
             + CalcItemSize(split_vertically ? ImVec2(thickness, splitter_long_axis_size) : ImVec2(splitter_long_axis_size, thickness), 0.0f, 0.0f);
...
struct Example : public Application
{
    ...
    void OnStart() override
    {
        ...
        m_HeaderBackground = LoadTexture("../external/imgui-node-editor/examples/blueprints-example/data/BlueprintBackground.png");
        m_SaveIcon = LoadTexture("../external/imgui-node-editor/examples/blueprints-example/data/ic_save_white_24dp.png");
        m_RestoreIcon = LoadTexture("../external/imgui-node-editor/examples/blueprints-example/data/ic_restore_white_24dp.png");
    ...
    void ShowLeftPane(float paneWidth)
    {
        ...
        for (auto& node : m_Nodes)
        {
            ...
            if (!node.SavedState.empty())
            {
                ...
                if (ImGui::IsItemActive())
                    drawList->AddImage(m_RestoreIcon, ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1),
                                       IM_COL32(255, 255, 255, 96));
                else if (ImGui::IsItemHovered())
                    drawList->AddImage(m_RestoreIcon, ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1),
                                       IM_COL32(255, 255, 255, 255));
    ...
    void OnFrame(float deltaTime) override
    {
        ...
        ed::Begin("Node editor");
        {
            ...
            for (auto& node : m_Nodes)
            {
                ...
                // const auto ImDrawList_AddRect = [](ImDrawList* drawList, const ImVec2& a, const ImVec2& b, ImU32 col, float rounding, int
